...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg font-display font-semibold leading-none tracking-tight text-gold',
      className
    )}
    {...props}
  />

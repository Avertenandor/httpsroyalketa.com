...
export default function Blog() {
  const posts: BlogPost[] = [
    {
      slug: 'microplastics-ocean-pollution',
      title: 'Микропластик и мусорные острова: что мы можем сделать',
      excerpt: 'Краткий обзор научных данных о микропластике (<5 мм), Большом тихоокеанском мусорном пятне и практиках снижения риска. Наши меры на хозяйстве и благодарность учёным.',
      date: '2025-11-05',
      readTime: '8 мин',

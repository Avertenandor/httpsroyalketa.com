...
export const caviarProductImages: ImageSource[] = [
  {
    ...
    url: '/img/caviar/excellent-taste/hero.webp',
    urlLarge: '/img/caviar/excellent-taste/hero.webp',
    urlMedium: '/img/caviar/excellent-taste/hero.webp',
    urlSmall: '/img/caviar/excellent-taste/hero.webp',
    alt: 'Gunkan с лососем и икрой крупным планом',
  },
  {
    id: 'caviar-macro-tray',
    url: '/img/caviar/premium-quality/hero.webp',
    urlLarge: '/img/caviar/premium-quality/hero.webp',
    urlMedium: '/img/caviar/premium-quality/hero.webp',
    urlSmall: '/img/caviar/premium-quality/hero.webp',
    alt: 'Макро икра кеты в лотке',
  },
  {
    id: 'ikura-don-yolk',
    url: '/img/species/salmon/ikura-don-1.jpg',
    urlLarge: '/img/species/salmon/ikura-don-1.jpg',
    urlMedium: '/img/species/salmon/ikura-don-1.jpg',
    urlSmall: '/img/species/salmon/ikura-don-1.jpg',
  ...
  {
    id: 'caviar-tin-macro',
    url: '/img/caviar/gift-packaging/hero.webp',
    urlLarge: '/img/caviar/gift-packaging/hero.webp',
    urlMedium: '/img/caviar/gift-packaging/hero.webp',
    urlSmall: '/img/caviar/gift-packaging/hero.webp',

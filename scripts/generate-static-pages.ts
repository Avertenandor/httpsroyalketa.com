...
const pages: PageMeta[] = [
  ...
  {
    path: '/salmon-info',
    title: 'Лососёвые рыбы и красная икра | Royal Keta',
  ...
  {
    path: '/sturgeon-info',
    title: 'Осетровые рыбы и чёрная икра | Royal Keta',
    description: 'Полное руководство по семейству осетровых: белуга, калуга, осетр, севрюга, стерлядь. Виды чёрной икры, сравнение с красной, польза для детей.',
